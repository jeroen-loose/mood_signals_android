...
class DbHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    private val SQL_CREATE_ENTRIES = arrayOf(
            ...
            "PRIMARY KEY (${DbContract.SignalValue.COLUMN_NAME_SIGNAL_ID}, ${DbContract.SignalValue.COLUMN_NAME_SCORE})",
            ...
            "PRIMARY KEY (${DbContract.DaySignalValue.COLUMN_NAME_DAY_ID}, ${DbContract.DaySignalValue.COLUMN_NAME_SIGNAL_ID}",
